...
package be.rbdgt.customProcessingOCV;

import be.rbdgt.customProcessingOCV.Contour;
import be.rbdgt.customProcessingOCV.ContourComparator;
import be.rbdgt.customProcessingOCV.Histogram;
import be.rbdgt.customProcessingOCV.Line;
import be.rbdgt.customProcessingOCV.Flow;
...
public class OpenCV {
	...
	private String version = "opencv_java401";
    ...
    private void initNative(){
    	if(!nativeLoaded){
	    	...
	    	try {
	    		...
	    		System.err.println("Cannot load local version of "+version+" : Linux 32/64, arm7, Windows 32 bits or Mac Os 64 bits are only avaible");
	    		e.printStackTrace();
	    	}
	...
	*/
	...
	public void startBackgroundSubtraction(int history, int nMixtures, double backgroundRatio){
		//backgroundSubtractor = new BackgroundSubtractorMOG2(history, nMixtures, backgroundRatio);
	}
  ...
  public void open(int size) {
	...
	public void loadImage(PImage img){				
		// FIXME: is there a better way to hold onto this?
		inputImage = img;
