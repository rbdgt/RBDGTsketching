...
public class Ddelaunay {
	...
	public Ddelaunay(Logger log, PictureSketchV2 pa, Stabilo stabilo){
		this.log = log;
		this.pa = pa;
		this.stabilo = stabilo;
	}
	
	public void draw(PImage img, int strokeWeight, int detColor, int penColor, int minLength, int maxLength, int particles) {
		
		log.writeLogLine("[ DELAUNAY ]");
		//log.writeLogLine("-----------------------------------------");
